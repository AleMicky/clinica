...
export const menuGroups: MenuGroup[] = [
    ...
    },
    {
        ...
        items: [
            ...
            {
                key: '/recursos-humanos/turnos',
                to: '/recursos-humanos/turnos',
                icon: <ClockCircleOutlined />,
                label: 'Turnos',
                roles: [AppRole.Admin],
            },
            {
                key: '/recursos-humanos/programacion-diaria',
                to: '/recursos-humanos/programacion-diaria',
    ...
    },
    {
        ...
        items: [
            ...
            {
                key: '/laboratorio/tipos-examen',
                to: '/laboratorio/tipos-examen',
    ...
    },
    {
        ...
        items: [
            ...
            {
                key: '/caja/metodos-pago',
                to: '/caja/metodos-pago',
                icon: <DollarOutlined />,
    ...
    },
    {
        key: 'almacen',
        label: 'Almacén',
        roles: [AppRole.Admin, AppRole.Farmacia],
        items: [
            {
            ...
            {
                key: '/almacen/unidades-medida',
                to: '/almacen/unidades-medida',
                icon: <ColumnHeightOutlined />,
                label: 'Unidades de medida',
                roles: [AppRole.Admin, AppRole.Farmacia],
            },
            {
                key: '/almacen/formas-farmaceuticas',
                to: '/almacen/formas-farmaceuticas',
                icon: <ExperimentOutlined />,
                label: 'Formas farmacéuticas',
                roles: [AppRole.Admin, AppRole.Farmacia],
            },
            {
                key: '/almacen/almacenes',
    ...
    },
    {
        ...
        items: [
            ...
            {
                key: '/farmacia/dispensaciones',
                to: '/farmacia/dispensaciones',
                icon: <MedicineBoxOutlined />,
    ...
    },
    {
        ...
        items: [
            ...
            {
                key: '/parametros/unidades-medida',
                to: '/parametros/unidades-medida',
                icon: <ColumnHeightOutlined />,
                label: 'Unidades de medida',
                roles: [AppRole.Admin],
            },
