    ...
    : IAjusteInventarioService
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        {
            TipoAjusteInventario.Positivo => ("AJUSTE_POSITIVO", $"Sobrante o ingreso por ajuste - Ref: {entity.Numero}"),
            TipoAjusteInventario.Negativo => ("AJUSTE_NEGATIVO", $"Faltante, merma o daño en almacén - Ref: {entity.Numero}"),
            _ => ("AJUSTE_POSITIVO", $"Sobrante o ingreso por ajuste - Ref: {entity.Numero}"),
        };
        ...
        var requestIntegracion = new MovimientoInventarioIntegracionRequest
        {
            ...
            TipoReferencia = "AJUSTE_INVENTARIO",
