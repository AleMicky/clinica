...
public abstract class ConvenioRequestValidator<TRequest>
    : AbstractValidator<TRequest>
    where TRequest : ConvenioRequest
{
    protected ConvenioRequestValidator()
    {
        RuleFor(x => x.Codigo)
            .NotEmpty()
...
public sealed class CreateConvenioRequestValidator
    : ConvenioRequestValidator<CreateConvenioRequest>;

public sealed class UpdateConvenioRequestValidator
    : ConvenioRequestValidator<UpdateConvenioRequest>;
