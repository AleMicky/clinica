...
import { Download, FileSpreadsheet, Loader2, Network, Plus, RefreshCw } from "lucide-react";
            ...
            <div className="flex items-center gap-2.5">
                ...
                <div>
                    ...
                    <p className="text-[11px] text-muted-foreground line-clamp-1">
                        Administración de áreas organizacionales, servicios clínicos y estructura jerárquica.
                    </p>
                </div>
            </div>
