...
import { ArrowLeftRight, Plus, RefreshCw, GitCompareArrows } from "lucide-react";
import { Button } from "@/components/ui/button";
import { Badge } from "@/components/ui/badge";

interface TransferenciaAlmacenHeaderProps {
  totalItems?: number;
  onRefresh?: () => void;
  isRefreshing?: boolean;
}

export function TransferenciaAlmacenHeader({
  totalItems = 0,
  onRefresh,
  isRefreshing = false,
}: TransferenciaAlmacenHeaderProps) {
  return (
      ...
      <div className="flex items-center gap-2.5">
        ...
        <div>
          ...
          <p className="text-[11px] text-muted-foreground leading-tight">
            Gestión y seguimiento de envíos, traslados y recepciones de stock entre depósitos
          </p>
        </div>
      </div>
