...
public sealed class TipoAtencionService(AtencionMedicaDbContext context) : ITipoAtencionService
{
    public async Task<PagedResult<TipoAtencionResponse>> GetPagedAsync(
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        var query = context.TiposAtencion.AsNoTracking();
        ...
        return new PagedResult<TipoAtencionResponse>(items, total, page, pageSize);
    }

    public async Task<TipoAtencionResponse?> GetByIdAsync(
        Guid id,
        CancellationToken cancellationToken = default)
    {
        return await context.TiposAtencion
            .AsNoTracking()
            .Where(x => x.Id == id)
            .Select(x => ToResponse(x))
    ...
    public async Task<TipoAtencionResponse> CreateAsync(
    ...
    public async Task<TipoAtencionResponse> UpdateAsync(
        Guid id,
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        if (entity is null)
            throw new NotFoundException("Tipo de atención no encontrado.");
    ...
    public async Task DeleteAsync(Guid id, CancellationToken cancellationToken = default)
    {
        ...
        context.TiposAtencion.Remove(entity);
        await context.SaveChangesAsync(cancellationToken);
    }
    ...
    {
        var exists = await context.TiposAtencion.AnyAsync(
    ...
    private static TipoAtencionResponse ToResponse(TipoAtencion entity) =>
