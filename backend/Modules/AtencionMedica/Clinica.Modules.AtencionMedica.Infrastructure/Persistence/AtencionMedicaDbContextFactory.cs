...
public class AtencionMedicaDbContextFactory : IDesignTimeDbContextFactory<AtencionMedicaDbContext>
{
    public AtencionMedicaDbContext CreateDbContext(string[] args)
    {
        var configuration = BuildConfiguration();

        var optionsBuilder = new DbContextOptionsBuilder<AtencionMedicaDbContext>();
        optionsBuilder.UseSqlServer(configuration.GetConnectionString("DefaultConnection"));

        return new AtencionMedicaDbContext(optionsBuilder.Options);
    }
