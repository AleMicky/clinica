...
public class UpdateContactoEmergenciaRequestValidator : AbstractValidator<UpdateContactoEmergenciaRequest>
{
    public UpdateContactoEmergenciaRequestValidator()
    {
