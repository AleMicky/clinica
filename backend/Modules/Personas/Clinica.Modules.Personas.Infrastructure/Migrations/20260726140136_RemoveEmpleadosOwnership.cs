...
/// <inheritdoc />
public partial class RemoveEmpleadosOwnership : Migration
{
    /// <inheritdoc />
    protected override void Up(MigrationBuilder migrationBuilder)
    {
        // Empleados pasa a ownership de RecursosHumanos (schema recursos_humanos).
        // RH migra primero; en installs frescos la tabla aún la crea Personas y aquí se transfiere.
