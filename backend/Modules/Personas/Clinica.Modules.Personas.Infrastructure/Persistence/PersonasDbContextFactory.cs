...
public class PersonasDbContextFactory : IDesignTimeDbContextFactory<PersonasDbContext>
{
    public PersonasDbContext CreateDbContext(string[] args)
    {
        ...
        return new PersonasDbContext(optionsBuilder.Options);
    }
