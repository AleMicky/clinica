...
public sealed class CategoriaProductoConfiguration : BaseEntityConfiguration<CategoriaProducto>
{
    public override void Configure(EntityTypeBuilder<CategoriaProducto> builder)
    {
