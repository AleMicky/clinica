...
public sealed class MovimientoAlmacenConfiguration : BaseEntityConfiguration<MovimientoAlmacen>
{
    public override void Configure(EntityTypeBuilder<MovimientoAlmacen> builder)
    {
        base.Configure(builder);
        builder.ToTable("MovimientosAlmacen");
        ...
        builder.HasOne(x => x.TipoMovimientoAlmacen)
            .WithMany(x => x.Movimientos)
            .HasForeignKey(x => x.TipoMovimientoAlmacenId)
        ...
        builder.HasMany(x => x.Detalles)
            .WithOne(x => x.MovimientoAlmacen)
            .HasForeignKey(x => x.MovimientoAlmacenId)
